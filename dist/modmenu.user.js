...
// @namespace    slash.gay
// @version      5.0.1
// @description  character.ai improvements
// @author       Slash
...
`;
  ...
  var chat_manager_default = {
    ...
    code(api, container) {
      ...
      copyBtn.addEventListener("click", async () => {
        ...
        const endTurnId = prompt("End turn ID (optional):") || void 0;
    ...
    code(api, container) {
      ...
      async function load() {
        ...
        try {
          ...
          status.textContent = "Updated " + (/* @__PURE__ */ new Date()).toLocaleTimeString();
  ...
  function isProtected(el) {
    ...
    if (el.dataset && (el.dataset.caiProtected || el.dataset.caiHidden)) return false;
    return false;
  }
  ...
  var model_enforcer_default = {
    ...
    code(api, container) {
      ...
      const chatObserver = setInterval(autoApply, 2e3);
      loadModels();
      return () => {
